...
cat > /etc/systemd/system/truck-app.service << 'SVCEOF'
[Unit]
Description=Logistics truck-app
...
ExecStart=/opt/logistics/aws_setup/excercise_logistics/.venv/bin/python -m truck_app.main
Restart=always
RestartSec=10
...
systemctl enable truck-app
systemctl start truck-app

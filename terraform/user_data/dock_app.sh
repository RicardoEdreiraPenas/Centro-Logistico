...
cat > /etc/systemd/system/dock-app.service << 'SVCEOF'
[Unit]
Description=Logistics dock-app
...
ExecStart=/opt/logistics/aws_setup/excercise_logistics/.venv/bin/python -m dock_app.main
Restart=always
RestartSec=10
...
systemctl enable dock-app
systemctl start dock-app
